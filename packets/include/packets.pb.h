...
#ifndef GOOGLE_PROTOBUF_INCLUDED_packets_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_packets_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:packets.LoginRequest) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "packets.LoginRequest"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:packets.LoginRequest)
 private:
  class _Internal;
...
inline const std::string& LoginRequest::username() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:packets.LoginRequest.username)
...
inline PROTOBUF_ALWAYS_INLINE void LoginRequest::set_username(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:packets.LoginRequest.username)
}
inline std::string* LoginRequest::mutable_username() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_username();
  // @@protoc_insertion_point(field_mutable:packets.LoginRequest.username)
  return _s;
}
...
inline std::string* LoginRequest::release_username() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:packets.LoginRequest.username)
...
inline void LoginRequest::set_allocated_username(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:packets.LoginRequest.username)
}
...
inline const std::string& LoginRequest::password() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:packets.LoginRequest.password)
...
inline PROTOBUF_ALWAYS_INLINE void LoginRequest::set_password(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:packets.LoginRequest.password)
}
inline std::string* LoginRequest::mutable_password() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_password();
  // @@protoc_insertion_point(field_mutable:packets.LoginRequest.password)
  return _s;
}
...
inline std::string* LoginRequest::release_password() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:packets.LoginRequest.password)
...
inline void LoginRequest::set_allocated_password(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:packets.LoginRequest.password)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_packets_2eproto_2epb_2eh
